        ...
        <form action="{{ route('kk.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="mb-3 col-md-6">
              <label class="form-label" for="nik">NIK <span class="ml-1 text-danger">*</span></label>
              <div class="input-group input-group-merge">
                <span id="nik" class="input-group-text"></span>
                <input type="number" name="nik" class="form-control" id="nik" aria-describedby="nik" max="9999999999999999" required/>
              </div>
            </div>
            <div class="mb-3 col-md-6">
            ...
            <div class="mb-3 col-md-6">
              <label for="html5-input" class="col-md-5 col-form-label">Nama Ayah <span class="ml-1 text-danger">*</span></label>
              <div class="input-group input-group-merge">
            ...
            <div class="mb-3 col-md-6">
              <label for="html5-input" class="col-md-5 col-form-label">Nama Ibu <span class="ml-1 text-danger">*</span></label>
              <div class="input-group input-group-merge">
            ...
            <div class="col-md-6 mb-3">
              <label for="file_buku_nikah" class="form-label">File Fotocopy Buku Nikah / AKTA Kelahiran <span class="ml-1 text-danger">*</span></label>
