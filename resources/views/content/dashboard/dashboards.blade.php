          ...
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/suratkk.jpg')}}" alt="Credit Card" class="rounded">
              </div>
            </div>
            <h6 class="d-block mb-1">Kartu Keluarga (KK)</h6>
            <h2 class="card-title mb-1">58</h2>
          </div>
        </div>
      </div>
      <div class="col-2 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="d-block mb-1">Kartu Tanda Penduduk (KTP)</h6>
            <h2 class="card-title mb-1">33</h2>
          </div>
        </div>
      </div>
      <div class="col-2 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/bangunann.jpg')}}" alt="chart success" class="rounded">
              </div>
            </div>
            <h6 class="d-block mb-1">Izin Mendirikan Bangunan </h6>
      ...
      <div class="col-2 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="d-block mb-1">Surat Izin Usaha Perdagangan</h6>
            <h2 class="card-title mb-1">28</h2>
          </div>
        </div>
      </div>
