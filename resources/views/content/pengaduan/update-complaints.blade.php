          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" id="basic-icon-default-name" name="nama" class="form-control" value="{{$pengaduan->nama}}" aria-describedby="basic-icon-default-name2" required/>
              </div>
            </div>
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="number" class="form-control" name="nik" id="basic-icon-default-nik"  value="{{$pengaduan->nik}}" aria-describedby="basic-icon-default-nik2" required/>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" id="basic-icon-default-tittle" name="judul_pengaduan"  value="{{$pengaduan->judul_pengaduan}}" class="form-control tittle-mask" aria-describedby="basic-icon-default-tittle2" required/>
              </div>
            </div>
            <div class="col-md-6 mb-3">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" id="basic-icon-default-lokasi" name="lokasi_pengaduan"  value="{{$pengaduan->lokasi_pengaduan}}" class="form-control" aria-describedby="basic-icon-default-lokasi2" required/>
              </div>
            </div>
            <div class="col-md-6 mb-3">
              ...
              <input class="form-control" type="file" id="formFile" name="file_pengaduan">
            </div>
            <div class="mb-3">
              <label class="form-label" for="basic-default-desc">Deskripsi Pengaduan</label>
              <textarea id="basic-default-desc" class="form-control" name="deskripsi" placeholder="Ada yang bisa kami bantu ?" required>{{$pengaduan->deskripsi}}</textarea>
            </div>
          </div>
